...
MODS = [
    ...
    ("DS_VehicleAdaptations", "1_DS_VehicleAdaptations", "mod", True, [
        "python3 tools/verify_xml.py",
        "{DOTNET} build src/VehicleAdaptations.csproj -c Release -v q --nologo",
        "rm -rf mod && mkdir -p mod/Config",
        "cp src/bin/Release/VehicleAdaptations.dll mod/",
        "cp {MODS}/0_TFP_Harmony/0Harmony.dll mod/",
        "cp Config/blocks.xml mod/Config/",
        "cp ModInfo.xml VehicleAdaptationsConfig.xml mod/",
        "cp README.md mod/README_VehicleAdaptations.txt",
        "rm -rf {MODS}/1_DS_VehicleAdaptations",
        "cp -r mod {MODS}/1_DS_VehicleAdaptations",
    ]),
